...
from auth.schemas import RoleCreateSchema, UserCreate, UserRead, UserUpdate
from auth.services import create_default_role, create_role, get_role
...
async def create_default_role_router(
    session: AsyncSession = Depends(get_async_session),
):
